...
public class TemplateController {
    ...
    public Result<Template> findByCatogoryId(@PathVariable(value = "id") Integer categoryId) {
        Template templates = templateService.findByCatogoryId(categoryId);
        return new Result<>(true, StatusCode.OK, "查询模板信息成功", templates);
    }
